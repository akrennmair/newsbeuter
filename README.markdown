...
Downloading
-----------
You can download the latest version of newsbeuter from the [official website](http://www.newsbeuter.org/)
...
- [libcurl (version 7.18.0 or newer)](http://curlm.haxx.se/download.html)
- [GNU gettext (on systems that don't provide gettext in the lib)](ftp://ftp.gnu.org/gnu/gettext/)
