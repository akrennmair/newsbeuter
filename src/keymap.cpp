...
static op_desc opdescs[] = {
	...
	{ OP_OPENINPLAYER,		"open-in-player",			"y",	_("Open article in player"),			KM_FEEDLIST | KM_ARTICLELIST | KM_ARTICLE },
	{ OP_OPENPLAYER_AND_MARK,  "open-in-player-and-mark-read",				"Y",	_("Open article in player and mark read"),			KM_ARTICLELIST},
